...
LUAROCKS_FILES = fs/unix/tools.lua fs/unix.lua fs/win32/tools.lua \
  fs/win32.lua fs/lua.lua \
  build/command.lua build/cmake.lua build/make.lua build/builtin.lua \
  fetch/cvs.lua fetch/git.lua fetch/sscm.lua fetch/svn.lua fetch/hg.lua \
  fetch/git_file.lua \
  tools/patch.lua tools/zip.lua tools/tar.lua \
  persist.lua list.lua require.lua repos.lua dir.lua make_manifest.lua \
  command_line.lua install.lua pack.lua type_check.lua make.lua path.lua \
  ...
  admin_remove.lua new_version.lua
